...
<form:form method="post" modelAttribute="signupForm" action="create" id="signupForm" cssClass="form-horizontal"  autocomplete="off">
    <fieldset>
        <legend>Enter Your Information now or create a team <a href="newTeam">here</a></legend>
        ...
        <c:set var="teamErrors"><form:errors path="selectedTeam"/></c:set>
        <div class="control-group<c:if test="${not empty teamErrors}"> error</c:if>">
            ...
            <div class="controls">
                ...
                <form:select path="selectedTeam">
                  	<form:options items="${Team}" itemValue="id" itemLabel="teamName"/>
                </form:select>
                <form:errors path="selectedTeam" cssClass="help-inline" element="span"/>
            </div>
        </div>
        
        <!--<form:input path="selectedTeam" id="field-selectedTeam"/>-->
